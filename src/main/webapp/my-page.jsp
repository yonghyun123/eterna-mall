...
<body>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tab" id="tab">
              ...
              <button class="tablinks"
                onclick="openCity(event, '개인정보 수정')" id="user-edit">개인정보
                수정</button>
            </div>
  ...
  <script>
			...
			$(document).on("click", "#confirmPasswdBtn", function(event) {
				var inputPW = document.getElementById('confirm_password').value;
				var form = document.createElement("form");
				form.setAttribute("charset", "UTF-8");
				form.setAttribute("method", "Post");
				form.setAttribute("action", "/user/updateInfo.mall");

				var hiddenDelete = document.createElement("input");
				hiddenPW.setAttribute("type", "hidden");
				hiddenPW.setAttribute("name", "inputPW");
				hiddenPW.setAttribute("value", inputPW);
